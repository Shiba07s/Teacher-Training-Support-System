...
<!--                             <th>Action</th> -->
                ...
                <div class="fixed-buttons">
                    <button class="btn btn-success" id="approveButton" style="font-size: 14px;" onclick="approveTraining();">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
//     var baseUrl = window.location.pathname.split('/')[1];  // Assuming the contextPath is the first segment
//     var apiUrl = '/' + baseUrl + '/api/mapping/first-level-approval?trainingid=' + TrainingId + '&venueid=' + VenueId;
        ...
        function displayTrainingData(data) {
            ...
            for (var i = 0; i < trainings.length; i++) {
                ...
                $("#trainingAndVenue").text(trainingName + "  ,     " + venueName);
...
//                 var status = '';
//                 if (recordStatus === 'approved' || recordStatus === 'waiting for next approval' ) {
//                     status = 'delivered';
