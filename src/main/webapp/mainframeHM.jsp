...
<!-- 						<li><a 
			...
			<li><a
				...
				target="/api/ttss/start">View Trainings</a></li>
				
				<li><a
				href="${pageContext.request.contextPath}/ApprovedTrainings.jsp"
				target="/api/ttss/start">Approved Teachers</a></li>
...
<!--     </button> -->
	...
	<div id="content">
		<div id="iframeContainer" style="height: 300px;">
			<iframe src="${pageContext.request.contextPath}/ApprovedTrainings.jsp"
