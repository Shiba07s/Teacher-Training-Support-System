...
<body>
 ...
 <script>
    ...
    function performSearch() {
        ...
        var url = '${pageContext.request.contextPath}/ProfileInformation.jsp?treasuryId=' + treasuryId;
	...
	<div class="row" style="margin: 0;">
		...
		<div class="col-md-3">
			<button onclick="approvedApi()" class="card-link"
				style="background: none; border: none; padding: 0; font: inherit; cursor: pointer;">
				<div>
					<div class="card-body custom-card-body" id="approvedCard"
		...
		<div class="col-md-3">
			<button onclick="rejectedApi()" class="card-link"
				style="background: none; border: none; padding: 0; font: inherit; cursor: pointer;">
				<div>
					<div class="card-body custom-card-body" id="rejectedCard"
		...
		<div class="col-md-3">
			<button onclick="nominatedApi()" class="card-link"
				style="background: none; border: none; padding: 0; font: inherit; cursor: pointer;">
				<div>
					<div class="card-body custom-card-body" id="nominatedCard"
		...
		<div class="col-md-3">
			<button onclick="secondApi()" class="card-link"
				style="background: none; border: none; padding: 0; font: inherit; cursor: pointer;">
				<div>
					<div class="card-body custom-card-body" id="budgetApprovalCard"
						style="background: linear-gradient(to top, #11f0e8,#11f0e8); color: white; float: right; margin-left: 120px;">
						<span><i class="fa fa-hand-rock-o" aria-hidden="true"></i></span>
						<h3 class="card-title"> Budget Approval </h3>
						<p id="rejectedCount"></p> 
	...
	$(document).ready(function() {
	    ...
	    if (menuPermissions) {
	        ...
	        // Check permissions and show/hide card bodies accordingly
	        $('#adminId').toggle(menuPermissions.waitingForApproval === 'YES');
	        $('#approvedCard').toggle(menuPermissions.approvedTrainees === 'YES');
	        $('#rejectedCard').toggle(menuPermissions.rejectedTrainees === 'YES');
	        $('#nominatedCard').toggle(menuPermissions.nomination === 'YES');
	        $('#budgetApprovalCard').toggle(menuPermissions.budgetApproval === 'YES');
	    } else {
