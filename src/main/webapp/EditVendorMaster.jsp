	...
	function editVendor() {
		...
		if (venueId) {
			$
					.ajax({
						type : "GET",
						url : "${pageContext.request.contextPath}/api/vender/getbyid/"
	...
	function updateVendor() {
		if (validateForm()) {
			...
			$
					.ajax({
						type : "PUT",
						url : "${pageContext.request.contextPath}/api/vender/updatebyid/"
								+ modifiedUid,
...
<body>
	<div class="container" align="center">
		...
		<form id="myForm" class="text-left" onsubmit="return saveForm()">
			<div class="row">
				<label for="sl" style="display: none;"> Agency id:</label> <input
					type="text" id="sl" style="display: none;" placeholder="" required
					readonly> <label for="vendorcode" style="display: none;">
					Agency Code:</label> <input type="text" id="vendorcode"
					style="display: none;" placeholder="Enter vendor Code" required>

				<label for="name" style="display: none;">Name:</label> <input
					type="text" id="name" style="display: none;" required>

				<div class="col-md-6">
					<label for="vendor">Agency:</label> <input type="text" id="vendor"
						placeholder="Enter vendor">
				</div>
				<div class="col-md-6">
					<label for="address">Agency Address:</label> <input type="text"
						id="address" required>
				</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<label for="contractperson">Contact Person:</label> <input
							type="text" id="contractperson" name="contractperson" required>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-6">
						<label for="contactno">Contact No:</label> <input type="text"
							id="contactno" placeholder="Enter Mobile No" required
							pattern="\d{10}"
			...
			<div class="row" style="display: flex; justify-content: center; margin-top: 5px;">
					<button type="submit" class="btn btn-primary" id="saveButton" style="margin-right: 5px;">Save</button>
					&nbsp;
