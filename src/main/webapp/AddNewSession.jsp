 ...
 */
@media only screen and (max-width:818px) and (min-width:802px) {
		...
		function addSessionData() {
			if (validateForm()) {
				...
				$
						.ajax({
							type : "POST",
							url : "${pageContext.request.contextPath}/api/session/create",
							contentType : "application/json",
							data : JSON.stringify(formData),
							success : function(response) {
								console.log(response);
								toastr
										.success("Training data saved successfully");
