			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped" id="trainingTable"
					...
					<thead class="thead-dark"
						...
						<tr>
							<th>Sl.no.</th>
							<th style="display: none;">TrainingMode Code </th>
							<th>Training Mode</th>
							<th style="display: none">Mode Status</th>
							<th>Action</th>
    ...
    $('#trainingTable').on('click', '.truncated-cell', function() {
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.append("<td style='display: none;'>" + training.trainingModecode + "</td>");
				row.append("<td>" + training.trainingMode + "</td>");
				row.append("<td style='display: none'>" + training.trainingStatus + "</td>");
