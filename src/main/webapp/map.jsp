...
<body>
  ...
  <div id="dynamicFieldsContainer" class="custom-font-size"></div>
    ...
    $(document).ready(function () {
      ...
      function addData() {
          ...
          $.ajax({
              type: 'GET',
              url: '${pageContext.request.contextPath}/api/mapping/data?mappingcode=' + venueId,
              dataType: 'json',
              success: function (existingData) {
                 ...
                 // Now you have the formDataJson, you can proceed with the AJAX call to update the data
                  $.ajax({
                      type: 'PUT',
                      url: '${pageContext.request.contextPath}/api/updateMapping/' + venueId,
      ...
      function editVenue() {
        ...
        if (mappingcode) {
          $.ajax({
            type: 'GET',
            url: '${pageContext.request.contextPath}/api/mapping/data?mappingcode=' + mappingcode,
            dataType: 'json',
