...
<body>
	...
	<div class="container" align="center">
		<h1>Add Trainee Limit</h1>
		<form id="addSessionForm" class="text-left">
			<div class="row">
				<div class="col-md-6">
					<label for="expense">Expense Type:</label> <select id="expense"
			...
			<div class="row">
				<div class="col-md-6">
					<label for="Trainee">Trainee Role:</label> <input type="text"
						...
						placeholder="Enter Trainee Role" required>
				</div>
				<div class="col-md-6">
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							dropdown.empty();
							dropdown
									.append('<option value="" selected disabled>Select Expense Type</option>');
							$.each(data, function(index, item) {
