									...
									.change(
											function() {
												var selectedOption = $(
														'#resources').find(
														':selected');
												const additionalData = selectedOption
														.data('byear');
												$("#budgeted_year").val(
														additionalData);
											});
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							districtDropdown
									.append('<option value="" selected disabled>Select Resourse</option>');
							$.each(data, function(index, item) {
								districtDropdown.append($('<option>', {
