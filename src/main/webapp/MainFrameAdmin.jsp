...
<div class="main-content">
	<div id="navbar">
		<div class="left-box">
<ul>
    <li id="dashboardMenuItem"><a href="${pageContext.request.contextPath}/api/dashboard" target="mainFrame">Dashboard</a></li>
    <li id="masterSetupMenuItem"><a href="${pageContext.request.contextPath}/api/MasterSetupScreen" target="mainFrame">Master Setup</a></li>
    <li id="academicCalendarMenuItem"><a href="${pageContext.request.contextPath}/AcademicCalender.jsp" target="mainFrame">Training Calendar Setup</a></li>
    <li id="scheduleTrainingMenuItem"><a href="${pageContext.request.contextPath}/api/schedule" target="mainFrame">Schedule Training</a></li>
    <li id="trainingToVenueMappingMenuItem"><a href="${pageContext.request.contextPath}/venuemapping.jsp" target="mainFrame">Training To Venue Mapping</a></li>
    <li id="budgetMenuItem"><a href="#">Budget</a>
        <ul>
            <li id="bs"><a href="${pageContext.request.contextPath}/BudgetMasterSetupScreen.jsp" target="mainFrame">Budget Master Setup</a></li>
            <li id="vbs"><a href="${pageContext.request.contextPath}/viewBudgetScreen.jsp" target="mainFrame">Budget Mapping View</a></li>
            <!-- <li><a href="${pageContext.request.contextPath}/budget_mapping_utilisation.jsp" target="mainFrame">Budget Approvals</a></li> -->
        </ul>
    </li>
    <li id="viewTrainingsMenuItem"><a href="${pageContext.request.contextPath}/viewTrainings.jsp" target="mainFrame">View Trainings</a></li>
    <li id="masterMappingMenuItem"><a href="${pageContext.request.contextPath}/viewMappingTrainings.jsp" target="mainFrame">Master Mapping</a></li>
    <li><a onclick="encryptWithRSA(publicKey, keys)">Go To Training Delivery</a></li>
</ul>
	...
	<div id="content">
		<div id="iframeContainer" style="height: 300px;">
			<iframe src="${pageContext.request.contextPath}/dashboard.jsp"
				name="mainFrame" id="mainFrame" style="width: 100%; height: 325px;"></iframe>
		</div>
	</div>
</div>
<script>
$(document).ready(function() {
    var menuPermissions = sessionStorage.getItem('apiData');

    console.log("menuPermissions :", menuPermissions);

    // Check if menu permissions data is available and valid
    if (menuPermissions) {
        menuPermissions = JSON.parse(menuPermissions); // Parse JSON string to object
        
        // Check permissions and show/hide menu items accordingly
        $('#dashboardMenuItem').toggle(menuPermissions.dashboard === 'YES');
        $('#masterSetupMenuItem').toggle(menuPermissions.masterSetup === 'YES');
        $('#academicCalendarMenuItem').toggle(menuPermissions.academicCalender === 'YES');
        $('#scheduleTrainingMenuItem').toggle(menuPermissions.scheduleTraining === 'YES');
        $('#trainingToVenueMappingMenuItem').toggle(menuPermissions.trainingToVenueMapping === 'YES');
        $('#budgetMenuItem').toggle(menuPermissions.budget === 'YES');
  
        $('#viewTrainingsMenuItem').toggle(menuPermissions.viewTrainings === 'YES');
        $('#masterMappingMenuItem').toggle(menuPermissions.masterMapping === 'YES');
    } else {
        console.error("Menu permissions data not found!");
    }
});
