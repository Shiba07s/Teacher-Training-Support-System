				...
				<table class="table table-bordered table-striped" id="trainingTable"
					...
					<thead class="thead-dark"
						...
						<tr>
							...
							<th>To Date</th>
							<th>Status</th>
							<th style="display: none">Record status</th>
							<th>Action</th>
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row
						.append('<td style="display: none">' + training.id
								+ '</td>');
				row.append("<td>" + (training.sessionCode ? training.sessionCode : '') + "</td>");
				row.append("<td>" + (training.sessionName ? training.sessionName : '') + "</td>");
				row.append("<td>" + (training.fromDate ? training.fromDate : '') + "</td>");
				row.append("<td>" + (training.toDate ? training.toDate : '') + "</td>");
				row.append("<td>" + (training.status ? training.status : '') + "</td>");
				row.append("<td style='display: none'>" + training.recordstatus + "</td>");
				row
