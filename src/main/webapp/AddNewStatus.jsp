...
<title>Add Training Status</title>
				...
				.ready(
						function() {
							function validateForm() {
								...
								if (statusname.trim() === "") {
									document.getElementById("pname").innerHTML = "Training Status is required";
									return false;
								} else {
							...
							window.saveGroup = function() {
								if (validateForm()) {
									...
									$
											.ajax({
												type : "POST",
												url : "${pageContext.request.contextPath}/api/create/status",
												contentType : "application/json",
												data : JSON.stringify(formData),
												success : function(response) {
													console.log(response);
													toastr
															.success("Training status saved successfully");
													setTimeout(function(){
