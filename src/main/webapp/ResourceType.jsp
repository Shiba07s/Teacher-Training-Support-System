			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped" id="trainingTable"
					...
					<thead class="thead-dark"
						...
						<tr>
							<th>Sl.no.</th>
							<th style="display: none;">Resource Code</th>
							<th>Resource Type</th>
							<th style="display: none">Resource Status</th>
							<th>Action</th>
    ...
    $('#trainingTable').on('click', '.truncated-cell', function() {
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.append("<td style='display: none;' >" + training.resourcecode + "</td>");
		...
		function deleteTraining(button, resourcecode) {
			...
			if (isConfirmed) {
				...
				$
						.ajax({
							type : "Delete",
							url : "${pageContext.request.contextPath}/api/deleteResourceType/" + resourcecode,
