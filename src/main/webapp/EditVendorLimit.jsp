...
<body>
    ...
    <div class="container" align="center">
        <h1>Edit Agency Limit</h1>
        <form id="myForm" class="text-left" onsubmit="return submitForm()">
			<div class="row">
				<div class="col-md-6">
					<label for="resources">Agency Name:</label> <input type="text"
				...
				<div class="form-column" style="display: none">
					<label for="actual_rate">Actual Rate:</label> <input type="text"
						id="actual_rate" required>
				</div>
...
//                      });
                     ...
                     if(data.unit === "Per Day"){
                         unit.append('<option value="lumpsum">LumpSum</option>'); // Adjust this according to your data structure
                         
                     }else{
                         unit.append('<option value="Per Day">Per Day</option>'); // Adjust this according to your data structure
