...
width: 250px; margin-top: 0px;
 ...
 #sbar{ 
 width: 300px; left: 310px; margin-top: 10px;
 } 
...
width: 150px; margin-top: 10px;
 ...
 #sbar{ 
font-size: 11px; width: 295px; text-align:right; margin-top: -35px;
 }
 .dataTables_filter { 
  font-size: 11px;  
 }
...
<script>
  jQuery(document).ready(function($) {
        ...
        $('#admintid').on('click', '.truncated-cell', function() {
            ...
            if (text === title) {
                ...
                if (text.length > 25) {
                    ...
                    $this.text(text.substring(0, 25) + '...'); // Adjust as needed
                }
            } else {
    ...
    $("#nominateRadio").click(function () {
        ...
        window.location.href = "${pageContext.request.contextPath}/SelfNominatedTrainee.jsp";
    });
...
//             data: { appliedtype: 'self' }, // Correct data object syntax
//             dataType: "json",
//             success: function (response) {
//              //showDropdowns(response);     
//             },
...
//         });
    ...
    function displayTrainingData(data) {
            ...
            row.append("<td>" + (training.tdescription ? training.tdescription : '') + "</td>");
               ...
               var appliedDateTime = new Date(training.applydateandtime);
                if (!isNaN(appliedDateTime.getTime())) {
                    ...
                    row.append("<td>" + (formattedDateTime ? formattedDateTime : '') + "</td>");
                } else {
        ...
        var dataTable = $('#admintid').DataTable({
            "columnDefs": [{
...
//                             $(this).attr('r', 'C' + (index + 1));
            ...
            "initComplete": function(settings, json) {
                // Move the DataTables length element to #length
                $('.dt-buttons').appendTo('#buttonss');
                $('#admintid_length').detach().appendTo('#length');
...
<!--             <input class="custom-font-size" type="radio" id="nominateRadio" name="attendType" value="nominate"> -->
<!--        <label class="custom-font-size" for="nominateRadio">Nominate</label> -->
<!--    </div> -->
<div class="custom-font-size" id="selfButton" style="margin-top: 10px;margin-left: 10px;">
        <input class="custom-font-size" type="radio" id="selfRadio" name="attendType" value="self"
            checked> <label class="custom-font-size" for="selfRadio">Self</label>
             <input class="custom-font-size" type="radio" id="nominateRadio" name="attendType" value="nominate">
        <label class="custom-font-size" for="nominateRadio">Nominate</label>
