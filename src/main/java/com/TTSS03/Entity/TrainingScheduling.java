...
@Table(name="t_schedule_training")
 
public class TrainingScheduling {
	...
	public String getNoofvenue() {
 
		return noofvenue;
 
	}
 
	public void setNoofvenue(String noofvenue) {
 
		this.noofvenue = noofvenue;
