	...
	<div class="container" align="center">
		...
		<form id="myForm" class="text-left" onsubmit="return saveForm()">
			<div class="form-row">
				...
				<label for="sl"style="display: none;"> Agency id:</label> <input type="text"
						id="sl" style="display: none;" placeholder="" required readonly>
					<label for="vendorcode" style="display: none;"> Agency Code:</label> <input type="text"
						id="vendorcode" style="display: none;" placeholder="Enter vendor Code" required>
