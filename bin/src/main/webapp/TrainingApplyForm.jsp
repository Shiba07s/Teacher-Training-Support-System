				...
				$
						.ajax({
							...
							success : function(secondResponse) {
								console
										.log(
												"Second POST request (${pageContext.request.contextPath}/save/previoustrainings) successful:",
												secondResponse);
							},
							error : function(xhr, status, error) {
								console
										.error(
												"Second POST request (${pageContext.request.contextPath}/save/previoustrainings) error:",
												error);
							},
							complete : function() {
