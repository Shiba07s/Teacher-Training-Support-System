...
<body>
	...
	<a href="${pageContext.request.contextPath}/mastermapping2.jsp" class="btn btn-success mt-2" style="background-color: #5cb85c; border-color: #5cb85c;">Create
		New Mapping +</a>
	...
	<script>
			...
			function fetchDataAndDisplay() {
				$.ajax({
					type : "GET",
					url : "${pageContext.request.contextPath}/api/mappingData",
					dataType : "json",
		...
		function deleteTraining(mappingcode) {
			...
			$.ajax({
				type : "Delete",
				url : "${pageContext.request.contextPath}/api/deleteMapping/" + mappingcode,
		...
		function editTraining(slno) {
		    ...
		    var editUrl = "${pageContext.request.contextPath}/map.jsp";
