...
<body>
 ...
 <div class="row">
   ...
   <div class="col-md-4">
    <a href="${pageContext.request.contextPath}/upload_academic_calender.jsp" class="btn btn-primary mt-2" style="margin-top: 20px; display: inline-block;">Upload Excel</a>
</div>

<!--         <div class="col-md-4"> -->
<!--     <button type="button" class="btn btn-primary" style="margin-top: 20px" onclick="uploadExcel()">Upload Excel</button> -->
<!-- </div> -->
